...
def menu():
    ...
    print("5. Relatório de veículos dos motorista")
...
def cadastrar_veiculo():
    placa = input("Digite qual é a placa do veículo: ")
    marca = input("Digite qual é a marca do veículo: ")
    modelo = input("Digite qual é o modelo do veículo: ")
    motorista = input("Digite qual é o motorista do veículo: ")
    veiculo = {"placa": placa, "marca": marca, "modelo": modelo, "motorista": motorista}
    funcoes.cadastrar_veiculo(veiculo)
    print("Veículo cadastrado com sucesso!")

def cadastrar_motorista():
    nome = input("Digite qual é o nome do motorista: ")
    idade = input("Digite qual a idade do motorista: ")
    cnh = input("Digite qual é a CNH do motorista: ")
...
def apagar_veiculo():
    placa = input("Digite qual é a placa do veículo a ser apagada: ")
    funcoes.apagar_veiculo(placa)
    print("Veículo apagado com sucesso!")

def atualizar_veiculo():
    placa = input("Digite qual é a placa do veículo a ser atualizado: ")
    marca = input("Digite qual é a marca do veículo: ")
    modelo = input("Digite qual é o novo modelo do veículo: ")
    motorista = input("Digite qual é o novo motorista do veículo: ")
